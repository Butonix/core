...
function get_sample_permalink_html( $id, $new_title = null, $new_slug = null ) {
	...
	if ( false === strpos( $permalink, '%postname%' ) && false === strpos( $permalink, '%pagename%' ) ) {
		...
		if ( '' == get_option( 'permalink_structure' ) && current_user_can( 'manage_options' ) && ! ( 'page' == get_option( 'show_on_front' ) && get_option( 'page_on_front' ) == $id ) ) {
			$return .= '<span id="change-permalinks"><a href="permalink.php" class="button button-small" target="_blank">' . __( 'Change Permalinks' ) . "</a></span>\n";
		}
	} else {
...
function wp_check_post_lock( $post_id ) {
	...
	/** This filter is documented in ADMIN_DIR/includes/ajax-actions.php */
...
function the_block_editor_meta_box_post_form_hidden_fields( $post ) {
	 ...
	 */
	ob_start();
	/** This filter is documented in ADMIN_DIR/edit-form-advanced.php */
