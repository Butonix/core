...
final class WP_Screen {
	 ...
	 *
	 * Some `$parent_file` values are 'edit.php?post_type=page', 'edit.php', and 'settings/index.php'.
	 *
	 * @since 3.3.0
	 * @var string
	 */
				...
				case 'post':
					...
					if ( $post_id ) {
						...
						if ( $post ) {
							...
							/** This filter is documented in ADMIN_DIR/post.php */
	...
	public function render_per_page_options() {
		...
		if ( 'edit_comments_per_page' == $option ) {
			...
			/** This filter is documented in ADMIN_DIR/includes/class-wp-comments-list-table.php */
			$per_page = apply_filters( 'comments_per_page', $per_page, $comment_status );
		} elseif ( 'categories_per_page' == $option ) {
			/** This filter is documented in ADMIN_DIR/includes/class-wp-terms-list-table.php */
			$per_page = apply_filters( 'edit_categories_per_page', $per_page );
		} else {
			/** This filter is documented in ADMIN_DIR/includes/class-wp-list-table.php */
			$per_page = apply_filters( "{$option}", $per_page );
		}

		// Back compat.
		if ( isset( $this->post_type ) ) {
			/** This filter is documented in ADMIN_DIR/includes/post.php */
