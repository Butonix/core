...
class Taxonomy {
	...
	protected function labels() {
		$default = array(
			...
			'add_or_remove_items'        => sprintf( __( 'Add or Remove %ss', 'Core' ), $this->name ),
			...
			'parent_item'                => sprintf( __( 'Parent %s:', 'Core' ), $this->name ),
			...
			'new_item_name'              => sprintf( __( 'New %s', 'Core' ), $this->name ),
			'all_items'                  => sprintf( __( 'All %ss', 'Core' ), $this->name ),
			'separate_items_with_commas' => sprintf( __( 'Separate %ss with comma', 'Core' ), $this->name ),
			'choose_from_most_used'      => sprintf( __( 'Choose from %ss most used', 'Core' ), $this->name )
		);
