...
use Rareloop\Router\RareMenuBox as RareMenuBox;
...
class Router
{
    ...
    public static function init()
    {
        ...
        static::system_login_routes($file);
    ...
    protected static function pull_registered_routes($params = []) {
        $registered_routes = $params->router->routes;
        
        new RareMenuBox($registered_routes);
    }


    public static function system_login_routes($file) {
        if ( file_exists( $file ) ) {
            require_once($file);
        }
    }
