 ...
 * (e.g. autoload.php or the wp-admin/ folder) are accessible.
 *
...
function get_admin_url( $blog_id = null, $path = '', $scheme = 'admin' ) {
	$url = get_site_url( $blog_id, ADMIN_DIR . '/', $scheme );
...
function network_admin_url( $path = '', $scheme = 'admin' ) {
	...
	$url = network_site_url( ADMIN_DIR . '/network/', $scheme );
...
function user_admin_url( $path = '', $scheme = 'admin' ) {
	$url = network_site_url( ADMIN_DIR . '/user/', $scheme );
