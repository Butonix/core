...
$custom_configuration_file = ABSPATH . CHARTI_CONFIGURATIONS__DIR . '/Kirki.php';
$custom_configuration_file = wp_normalize_path( $custom_configuration_file );

if ( file_exists( $custom_configuration_file ) ) {
	require_once $custom_configuration_file;
}
