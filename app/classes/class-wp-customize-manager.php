...
final class WP_Customize_Manager {
	...
	public function __construct( $args = array() ) {
		...
		require_once ABSPATH . WPINC . '/classes/class-wp-customize-setting.php';
		require_once ABSPATH . WPINC . '/classes/class-wp-customize-panel.php';
		require_once ABSPATH . WPINC . '/classes/class-wp-customize-section.php';
		require_once ABSPATH . WPINC . '/classes/class-wp-customize-control.php';
		...
		if ( in_array( 'widgets', $components, true ) ) {
			require_once ABSPATH . WPINC . '/classes/class-wp-customize-widgets.php';
			$this->widgets = new WP_Customize_Widgets( $this );
		}

		if ( in_array( 'nav_menus', $components, true ) ) {
			require_once ABSPATH . WPINC . '/classes/class-wp-customize-nav-menus.php';
		...
		if ( current_user_can( 'install_themes' ) || current_user_can( 'update_themes' ) ) {
			require_once ABSPATH . ADMIN_DIR . '/includes/update.php';
	...
	public function validate_setting_values( $setting_values, $options = array() ) {
		...
		foreach ( $setting_values as $setting_id => $unsanitized_value ) {
			...
			if ( ! is_wp_error( $validity ) ) {
				/** This filter is documented in wp-includes/classes/class-wp-customize-setting.php */
	...
	public function add_setting( $id, $args = array() ) {
		if ( $id instanceof WP_Customize_Setting ) {
			...
			/** This filter is documented in wp-includes/classes/class-wp-customize-manager.php */
	...
	public function handle_load_themes_request() {
		...
		require_once ABSPATH . ADMIN_DIR . '/includes/theme.php';
