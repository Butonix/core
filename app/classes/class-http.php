...
if ( ! class_exists( 'Requests' ) ) {
	require ABSPATH . WPINC . '/classes/class-requests.php';
...
class WP_Http {
	...
	public function request( $url, $args = array() ) {
		...
		if ( empty( $url ) || empty( $arrURL['scheme'] ) ) {
			...
			/** This action is documented in wp-includes/classes/class-http.php */
	...
	private function _dispatch_request( $url, $args ) {
		...
		/** This filter is documented in wp-includes/classes/class-http.php */
	 ...
	 *
	 * You block external URL requests by defining `WP_HTTP_BLOCK_EXTERNAL` as true in your `configuration.php`
