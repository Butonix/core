...
final class WP_Theme implements ArrayAccess {
	...
	/**
	 * Absolute path to the theme root, usually WP_CONTENT_DIR/themes
	 *
	 * @var string
	 */
	private $theme_root;
	...
	/**
	 * URL to the theme root, usually an absolute URL to WP_CONTENT_DIR/themes
	 *
	 * @var string
	 */
	...
	public function __construct( $theme_dir, $theme_root, $_child = null ) {
		...
		if ( is_array( $cache ) ) {
			...
			// Properly identify default themes that are inside a directory within WP_CONTENT_DIR/themes.
		...
		if ( ! is_array( $cache ) && $this->template != $this->stylesheet && ! file_exists( $this->theme_root . '/' . $this->template . '/index.php' ) ) {
			...
			// WP_CONTENT_DIR/themes/directory-of-themes/*
	 ...
	 *
	 * This is typically the absolute path to WP_CONTENT_DIR/themes.
	 *
	 * @since 3.4.0
	 *
	 ...
	 *
	 * This is typically the absolute URL to WP_CONTENT_DIR/themes. This forms the basis
	...
	public function get_screenshot( $uri = 'uri' ) {
		...
		if ( $screenshot ) {
			...
			return get_theme_root_uri($this->stylesheet) . '/' . $screenshot;
		} elseif ( 0 === $screenshot ) {
			return false;
		}
		...
		foreach ( array( 'png', 'gif', 'jpg', 'jpeg' ) as $ext ) {
			if ( file_exists( $this->get_stylesheet_directory() . "/screenshot.$ext" ) ) {
				...
				// the one above will always fail so this is the right line. Charti CMS @since 0.1
				return get_theme_root_uri($this->stylesheet) . '/' . 'screenshot.' . $ext;
	...
	public static function get_allowed_on_site( $blog_id = null ) {
		...
		/** This filter is documented in wp-includes/classes/class-wp-theme.php */
		return (array) apply_filters( 'site_allowed_themes', $allowed_themes[ $blog_id ], $blog_id );
	}
