...
require __DIR__ . '/classes/class-wp-hook.php';
 ...
 * plugin is located in WP_CONTENT_DIR/plugins/sampleplugin/sample.php, then
 * the name of this hook will become 'activate_sampleplugin/sample.php'.
 *
 * When the plugin consists of only one file and is (as by default) located at
 * WP_CONTENT_DIR/plugins/sample.php the name of this hook will be
 * 'activate_sample.php'.
 *
 * @since 2.0.0
 *
