...
function get_locale() {
	...
	// WPLANG was defined in configuration.
	if ( defined( 'WPLANG' ) ) {
		$locale = WPLANG;
	}
 ...
 * the translation file from `WP_CONTENT_DIR/languages`, removing the need
 ...
 *
 * Looks in the WP_CONTENT_DIR/languages directory for translations of
 * plugins or themes.
 *
 * @since 3.7.0
 *
...
function wp_dropdown_languages( $args = array() ) {
	...
	// Charti CMS added form-control class. Sorry, Wordpress! @since v0.1
	$output  = sprintf( '<select name="%s" id="%s" class="form-control">', esc_attr( $parsed_args['name'] ), esc_attr( $parsed_args['id'] ) );
	$output .= join( "\n", $structure );
	$output .= '</select>';
