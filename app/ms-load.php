 ...
 *
 * The default directory is WP_CONTENT_DIR/plugins. To change the default directory
 * manually, define `WP_PLUGIN_DIR` and `WP_PLUGIN_URL` in `configuration.php`.
 *
 * @access private
 * @since 3.1.0
 *
 ...
 * use the WP_CONTENT_DIR/blog-deleted.php, blog-inactive.php and
