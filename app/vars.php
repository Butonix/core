...
if ( is_admin() ) {
	...
	if ( is_network_admin() ) {
		preg_match( '#/' . ADMIN_DIR . '/network/?(.*?)$#i', $_SERVER['PHP_SELF'], $self_matches );
	} elseif ( is_user_admin() ) {
		preg_match( '#/' . ADMIN_DIR . '/user/?(.*?)$#i', $_SERVER['PHP_SELF'], $self_matches );
	} else {
		preg_match( '#/' . ADMIN_DIR . '/?(.*?)$#i', $_SERVER['PHP_SELF'], $self_matches );
	}
