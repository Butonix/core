...
function wp_print_media_templates() {
			...
			<div class="settings">
				...
				<# if ( 'image' === data.type ) { #>
					<span class="setting has-description" data-setting="alt">
						...
						<input class="form-control" type="text" id="attachment-details-two-column-alt-text" value="{{ data.alt }}" aria-describedby="alt-text-description" {{ maybeReadOnly }} />
					</span>
				...
				<span class="setting" data-setting="title">
					...
					<input class="form-control" type="text" id="attachment-details-two-column-title" value="{{ data.title }}" {{ maybeReadOnly }} />
				</span>
				<?php endif; ?>
				<# if ( 'audio' === data.type ) { #>
				<?php
				...
				<span class="setting" data-setting="<?php echo esc_attr( $key ); ?>">
					...
					<input class="form-control" type="text" id="attachment-details-two-column-<?php echo esc_attr( $key ); ?>" value="{{ data.<?php echo $key; ?> || data.meta.<?php echo $key; ?> || '' }}" />
				</span>
				<?php endforeach; ?>
				<# } #>
				<span class="setting" data-setting="caption">
					<label for="attachment-details-two-column-caption" class="name"><?php _e( 'Caption' ); ?></label>
					<textarea class="form-control" id="attachment-details-two-column-caption" {{ maybeReadOnly }}>{{ data.caption }}</textarea>
				</span>
				<span class="setting" data-setting="description">
					<label for="attachment-details-two-column-description" class="name"><?php _e( 'Description' ); ?></label>
					<textarea class="form-control" id="attachment-details-two-column-description" {{ maybeReadOnly }}>{{ data.description }}</textarea>
				</span>
				<span class="setting">
				...
				<span class="setting" data-setting="url">
					...
					<input type="text" class="form-control" id="attachment-details-two-column-copy-link" value="{{ data.url }}" readonly />
				</span>
	...
	<script type="text/html" id="tmpl-attachment-details">
		...
		<span class="setting" data-setting="url">
			...
			<input type="text" class="form-control" id="attachment-details-copy-link" value="{{ data.url }}" readonly />
		</span>
	</script>
