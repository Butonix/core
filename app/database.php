 ...
 * by setting the $wpdb global variable in WP_CONTENT_DIR/db.php
...
class wpdb {
	...
	public function db_connect( $allow_bail = true ) {
		...
		if ( ! $this->dbh && $allow_bail ) {
			...
			$message = '<h1 class="screen-reader-text">' . __( 'Error establishing a database connection' ) . "</h1>\n";
	...
	public function check_database_version() {
		...
		if ( version_compare( $this->db_version(), $required_mysql_version, '<' ) ) {
			...
			return new WP_Error( 'database_version', sprintf( __( '<strong>Error</strong>: Thirsty Core %1$s requires MySQL %2$s or higher' ), $wp_version, $required_mysql_version ) );
		}
	}
