...
function _wp_admin_bar_init() {
	...
	require_once ABSPATH . WPINC . '/classes/class-wp-admin-bar.php';
...
function wp_admin_bar_wp_menu( $wp_admin_bar ) {
	...
	$wp_logo_menu_args = array(
		'id'    => 'wp-logo',
		'title' => '<span class="ab-icon"></span><span class="screen-reader-text">' . __( 'About Chartí' ) . '</span>',
		'href'  => $about_url,
	);
	...
	$wp_admin_bar->add_node(
		array(
			...
			'id'     => 'wporg',
			'title'  => __( 'Official Website' ),
			'href'   => __( 'https://charti.dev/' ),
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			...
			'id'     => 'support-forums',
			'title'  => __( 'Support' ),
			'href'   => __( 'https://charti.dev/support/' ),
		)
	);
...
function wp_admin_bar_my_account_item( $wp_admin_bar ) {
	...
	$howdy = sprintf( __( 'Hey, %s' ), '<span class="display-name">' . $current_user->display_name . '</span>' );
