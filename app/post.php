...
// TODOCHARTI
// to be extended to support custom post type in separate data base tables
function wp_insert_post( $postarr, $wp_error = false, $post_type = null ) {
	global $wpdb;
	...
	$data = compact( 'post_author', 'post_date', 'post_date_gmt', 'post_content', 'post_content_filtered', 'post_title', 'post_excerpt', 'post_status', 'post_type', 'post_password', 'post_name', 'post_modified', 'post_modified_gmt', 'post_parent', 'menu_order', 'post_mime_type', 'guid' );
...
function wp_get_attachment_url( $attachment_id = 0 ) {
	...
	if ( $file ) {
		...
		if ( $uploads && false === $uploads['error'] ) {
			...
			} elseif ( false !== strpos( $file, WP_CONTENT_DIR . '/uploads' ) ) {
