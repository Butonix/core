...
if ( ! function_exists( 'wp_mail' ) ) :
	...
	function wp_mail( $to, $subject, $message, $headers = '', $attachments = array() ) {
		...
		if ( ! ( $phpmailer instanceof PHPMailer ) ) {
			require_once ABSPATH . WPINC . '/classes/class-phpmailer.php';
			require_once ABSPATH . WPINC . '/classes/class-smtp.php';
...
if ( ! function_exists( 'wp_clear_auth_cookie' ) ) :
	...
	function wp_clear_auth_cookie() {
		...
		// Settings cookies.
		setcookie( 'settings-' . get_current_user_id(), ' ', time() - YEAR_IN_SECONDS, SITECOOKIEPATH );
		setcookie( 'settings-time-' . get_current_user_id(), ' ', time() - YEAR_IN_SECONDS, SITECOOKIEPATH );
...
if ( ! function_exists( 'wp_salt' ) ) :
	 ...
	 * @since 2.5.0
	 *
	 * @link https://api.wordpress.org/secret-key/1.1/salt/ Create secrets for configuration.php
	 *
...
if ( ! function_exists( 'wp_hash_password' ) ) :
	...
	function wp_hash_password( $password ) {
		...
		if ( empty( $wp_hasher ) ) {
			require_once ABSPATH . WPINC . '/classes/class-phpass.php';
