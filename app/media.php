...
function _wp_get_attachment_relative_path( $file ) {
	...
	if ( false !== strpos( $dirname, WP_CONTENT_DIR . '/uploads' ) ) {
		// Get the directory name relative to the upload directory (back compat for pre-2.7 uploads).
		$dirname = substr( $dirname, strpos( $dirname, WP_CONTENT_DIR . '/uploads' ) + 18 );
...
function _wp_image_editor_choose( $args = array() ) {
	require_once ABSPATH . WPINC . '/classes/class-wp-image-editor.php';
	require_once ABSPATH . WPINC . '/classes/class-wp-image-editor-gd.php';
	require_once ABSPATH . WPINC . '/classes/class-wp-image-editor-imagick.php';
	/**
