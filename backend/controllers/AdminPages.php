...
class AdminPageController
{
    ...
    public function render_template_view($content_view, $template_view) {
      ...
      require_once ROOT_PATH . ADMIN_ROOT . '/content/' . $content_view . '.php';

      require_once ROOT_PATH . ADMIN_ROOT . '/views/' . $template_view . '.phtml';

    }

    protected function get_header() {

     require_once ROOT_PATH . ADMIN_ROOT. '/controllers/header.php';

    }

    protected function get_footer() {

      require_once ROOT_PATH . ADMIN_ROOT . '/controllers/footer.php';
