...
require_once ABSPATH . ADMIN_DIR . '/includes/class-walker-category-checklist.php';

/** WP_Internal_Pointers class */
require_once ABSPATH . ADMIN_DIR . '/includes/class-wp-internal-pointers.php';
...
var ajaxurl = '<?php echo admin_url( 'admin-ajax.php', 'relative' ); ?>',
	...
	<?php
	/** This action is documented in ADMIN_DIR/admin-header.php */
	...
	/** This filter is documented in ADMIN_DIR/admin-header.php */
...
function iframe_footer() {
	...
	<div class="hidden">
	<?php
	/** This action is documented in ADMIN_DIR/admin-footer.php */
 ...
 */
function get_submit_button( $text = '', $type = 'btn-primary large', $name = 'submit', $wrap = true, $other_attributes = '' ) {
	if ( ! is_array( $type ) ) {
		$type = explode( ' ', $type );
	}
...
<html xmlns="http://www.w3.org/1999/xhtml" class="<?php echo $admin_html_class; ?>"
	<?php
	/** This action is documented in ADMIN_DIR/includes/template.php */
	do_action( 'admin_xml_ns' );
...
function convert_to_screen( $hook_name ) {
	if ( ! class_exists( 'WP_Screen' ) ) {
		_doing_it_wrong(
			...
			sprintf(
				/* translators: 1: ADMIN_DIR/includes/template.php, 2: add_meta_box(), 3: add_meta_boxes */
				__( 'Likely direct inclusion of %1$s in order to use %2$s. This is very wrong. Hook the %2$s call into the %3$s action instead.' ),
				'<code>ADMIN_DIR/includes/template.php</code>',
