...
if ( $can_edit_terms ) {
	?>
<div id="col-container" class="row">

<div id="col-left" class="d-none">
<div class="col-wrap">
...
<div class="form-field form-required term-name-wrap">
	...
	<input class="form-control" name="tag-name" id="tag-name" type="text" value="" size="40" aria-required="true" />
	<p><?php _e( 'The name is how it appears on your site.' ); ?></p>
</div>
	<?php if ( ! global_terms_enabled() ) : ?>
<div class="form-field term-slug-wrap">
	<label for="tag-slug"><?php _e( 'Slug' ); ?></label>
	<input class="form-control" name="slug" id="tag-slug" type="text" value="" size="40" />
...
<div class="form-field term-description-wrap">
	...
	<textarea class="form-control" name="description" id="tag-description" rows="5" cols="40"></textarea>
