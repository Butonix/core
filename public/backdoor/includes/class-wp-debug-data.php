...
class WP_Debug_Data {
	...
	static function debug_data() {
		...
		$info['wp-dropins'] = array(
			...
			'show_count'  => true,
			'description' => sprintf(
				/* translators: %s: WP_CONTENT_DIR directory name. */
				__( 'Drop-ins are single files, found in the %s directory, that replace or enhance the CMS features in ways that are not possible for traditional plugins.' ),
		...
		$info['wp-constants'] = array(
			...
			'description' => __( 'These settings alter where and how parts of the CMS are loaded.' ),
			'fields'      => array(
				'ABSPATH'             => array(
					'label'   => 'ABSPATH',
					'value'   => ABSPATH,
				...
				'WPINC'             => array(
					'label' => 'WPINC',
					'value' => ( defined( 'WPINC' ) ? WPINC : __( 'Undefined' ) ),
					'debug' => ( defined( 'WPINC' ) ? WPINC : 'undefined' ),
				),
				'CONFIG_DIR'             => array(
					'label' => 'CONFIG_DIR',
					'value' => ( defined( 'CONFIG_DIR' ) ? CONFIG_DIR : __( 'Undefined' ) ),
					'debug' => ( defined( 'CONFIG_DIR' ) ? CONFIG_DIR : 'undefined' ),
				),
				'ADMIN_DIR'             => array(
					'label' => 'ADMIN_DIR',
					'value' => ( defined( 'ADMIN_DIR' ) ? ADMIN_DIR : __( 'Undefined' ) ),
					'debug' => ( defined( 'ADMIN_DIR' ) ? ADMIN_DIR : 'undefined' ),
				),

				'ADMIN_ASSETS'             => array(
					'label' => 'ADMIN_ASSETS',
					'value' => ( defined( 'ADMIN_ASSETS' ) ? ADMIN_ASSETS : __( 'Undefined' ) ),
					'debug' => ( defined( 'ADMIN_ASSETS' ) ? ADMIN_ASSETS : 'undefined' ),
				),

				'WP_CONTENT_DIR'             => array(
					'label' => 'WP_CONTENT_DIR',
					'value' => ( defined( 'WP_CONTENT_DIR' ) ? WP_CONTENT_DIR : __( 'Undefined' ) ),
					'debug' => ( defined( 'WP_CONTENT_DIR' ) ? WP_CONTENT_DIR : 'undefined' ),
				),

				'UPLOADS'             => array(
					'label' => 'UPLOADS',
					'value' => ( defined( 'UPLOADS' ) ? UPLOADS : __( 'Undefined' ) ),
		...
		$info['wp-filesystem'] = array(
			...
			'description' => __( 'Shows whether the system able to write to the directories it needs access to.' ),
			'fields'      => array(
				'wordpress'  => array(
					'label' => __( 'The main directory' ),
					'value' => ( $is_writable_abspath ? __( 'Writable' ) : __( 'Not writable' ) ),
					'debug' => ( $is_writable_abspath ? 'writable' : 'not writable' ),
				),
				WP_CONTENT_DIR => array(
					'label' => __( 'The '. WP_CONTENT_DIR ),
