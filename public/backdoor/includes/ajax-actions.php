...
function wp_ajax_imgedit_preview() {
	...
	include_once ABSPATH . ADMIN_DIR . '/includes/image-edit.php';
...
function wp_ajax_autocomplete_user() {
	...
	/** This filter is documented in ADMIN_DIR/user-new.php */
...
function wp_ajax_get_community_events() {
	require_once ABSPATH . ADMIN_DIR . '/includes/class-wp-community-events.php';
...
function wp_ajax_add_menu_item() {
	...
	require_once ABSPATH . ADMIN_DIR . '/includes/nav-menu.php';
	...
	/** This filter is documented in ADMIN_DIR/includes/nav-menu.php */
...
function wp_ajax_wp_link_ajax() {
	...
	if ( ! class_exists( '_WP_Editors', false ) ) {
		require ABSPATH . WPINC . '/classes/class-wp-editor.php';
	}
...
function wp_ajax_inline_save() {
	...
	if ( ! empty( $data['tax_input'] ) ) {
		foreach ( $data['tax_input'] as $taxonomy => $terms ) {
			...
			/** This filter is documented in ADMIN_DIR/includes/class-wp-posts-list-table.php */
...
function wp_ajax_save_widget() {
	...
	/** This action is documented in ADMIN_DIR/widgets.php */
...
function wp_ajax_delete_inactive_widgets() {
	...
	/** This action is documented in ADMIN_DIR/includes/ajax-actions.php */
	do_action( 'load-widgets.php' ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
	/** This action is documented in ADMIN_DIR/includes/ajax-actions.php */
	do_action( 'widgets.php' ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
	/** This action is documented in ADMIN_DIR/widgets.php */
...
function wp_ajax_get_revision_diffs() {
	require ABSPATH . ADMIN_DIR . '/includes/revision.php';
...
function wp_ajax_query_themes() {
	...
	/** This filter is documented in /includes/class-wp-theme-install-list-table.php */
...
function wp_ajax_crop_image() {
	...
	switch ( $context ) {
		case 'site-icon':
			...
			/** This filter is documented in ADMIN_DIR/includes/class-custom-image-header.php */
...
function wp_ajax_install_theme() {
	...
	require_once ABSPATH . ADMIN_DIR . '/includes/class-wp-upgrader.php';
	include_once ABSPATH . ADMIN_DIR . '/includes/theme.php';
...
function wp_ajax_install_plugin() {
	...
	require_once ABSPATH . ADMIN_DIR . '/includes/class-wp-upgrader.php';
	include_once ABSPATH . ADMIN_DIR . '/includes/plugin-install.php';
...
function wp_ajax_health_check_get_sizes() {
	...
	if ( ! class_exists( 'WP_Debug_Data' ) ) {
		require_once ABSPATH . ADMIN_DIR . '/includes/class-wp-debug-data.php';
	}
