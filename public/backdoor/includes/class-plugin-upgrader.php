...
class Plugin_Upgrader extends WP_Upgrader {
	...
	public function bulk_upgrade( $plugins, $args = array() ) {
		...
		$res = $this->fs_connect( array( ABSPATH . WP_CONTENT_DIR, WP_PLUGIN_DIR ) );
		if ( ! $res ) {
			$this->skin->footer();
			return false;
		}
	...
	public function check_package( $source ) {
		...
		$working_directory = str_replace( $wp_filesystem->wp_content_dir(), trailingslashit( ABSPATH . WP_CONTENT_DIR ), $source );
