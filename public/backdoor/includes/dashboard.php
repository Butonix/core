...
function wp_dashboard_setup() {
	...
	if ( 'POST' == $_SERVER['REQUEST_METHOD'] && isset( $_POST['widget_id'] ) ) {
		...
		ob_start(); // Hack - but the same hack ADMIN_DIR/widgets.php uses.
 ...
 * which is later replaced by Ajax call (see top of /ADMIN_DIR/index.php)
 *
 * @since 2.5.0
...
function wp_welcome_panel() {
	...
	<h2><strong><?php _e( 'This is Chartí' ); ?></strong></h2>
	<p class="about-description">
		The better version of Wordpress, more flexible and stable.
