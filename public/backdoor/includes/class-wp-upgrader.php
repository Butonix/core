...
require_once ABSPATH . ADMIN_DIR . '/includes/class-wp-upgrader-skin.php';

/** Plugin_Upgrader_Skin class */
require_once ABSPATH . ADMIN_DIR . '/includes/class-plugin-upgrader-skin.php';

/** Theme_Upgrader_Skin class */
require_once ABSPATH . ADMIN_DIR . '/includes/class-theme-upgrader-skin.php';

/** Bulk_Upgrader_Skin class */
require_once ABSPATH . ADMIN_DIR . '/includes/class-bulk-upgrader-skin.php';

/** Bulk_Plugin_Upgrader_Skin class */
require_once ABSPATH . ADMIN_DIR . '/includes/class-bulk-plugin-upgrader-skin.php';

/** Bulk_Theme_Upgrader_Skin class */
require_once ABSPATH . ADMIN_DIR . '/includes/class-bulk-theme-upgrader-skin.php';

/** Plugin_Installer_Skin class */
require_once ABSPATH . ADMIN_DIR . '/includes/class-plugin-installer-skin.php';

/** Theme_Installer_Skin class */
require_once ABSPATH . ADMIN_DIR . '/includes/class-theme-installer-skin.php';

/** Language_Pack_Upgrader_Skin class */
require_once ABSPATH . ADMIN_DIR . '/includes/class-language-pack-upgrader-skin.php';

/** Automatic_Upgrader_Skin class */
require_once ABSPATH . ADMIN_DIR . '/includes/class-automatic-upgrader-skin.php';

/** WP_Ajax_Upgrader_Skin class */
require_once ABSPATH . ADMIN_DIR . '/includes/class-wp-ajax-upgrader-skin.php';
...
class WP_Upgrader {
	...
	public function generic_strings() {
		...
		$this->strings['fs_no_content_dir'] = __( 'Unable to locate WordPress content directory ('.WP_CONTENT_DIR .').' );
	...
	public function install_package( $args = array() ) {
		 ...
		 * destination directory (WP_PLUGIN_DIR / WP_CONTENT_DIR/themes) intending
	...
	public function run( $options ) {
		...
		$res = $this->fs_connect( array( ABSPATH . WP_CONTENT_DIR, $options['destination'] ) );
...
require_once ABSPATH . ADMIN_DIR . '/includes/class-plugin-upgrader.php';

/** Theme_Upgrader class */
require_once ABSPATH . ADMIN_DIR . '/includes/class-theme-upgrader.php';

/** Language_Pack_Upgrader class */
require_once ABSPATH . ADMIN_DIR . '/includes/class-language-pack-upgrader.php';

/** Core_Upgrader class */
require_once ABSPATH . ADMIN_DIR . '/includes/class-core-upgrader.php';

/** File_Upload_Upgrader class */
require_once ABSPATH . ADMIN_DIR . '/includes/class-file-upload-upgrader.php';

/** WP_Automatic_Updater class */
require_once ABSPATH . ADMIN_DIR . '/includes/class-wp-automatic-updater.php';
