...
<div class="tagsdiv" id="<?php echo $tax_name; ?>">
	...
	<div class="nojs-tags hide-if-js">
		...
		<p><textarea name="<?php echo "tax_input[$tax_name]"; ?>" rows="3" cols="20" class="form-control the-tags" id="tax-input-<?php echo $tax_name; ?>" <?php disabled( ! $user_can_assign_terms ); ?> aria-describedby="new-tag-<?php echo $tax_name; ?>-desc"><?php echo str_replace( ',', $comma . ' ', $terms_to_edit ); // textarea_escaped by esc_attr() ?></textarea></p>
	</div>
	<?php if ( $user_can_assign_terms ) : ?>
	<div class="ajaxtag hide-if-no-js">
		<label class="screen-reader-text" for="new-tag-<?php echo $tax_name; ?>"><?php echo $taxonomy->labels->add_new_item; ?></label>
		<input data-wp-taxonomy="<?php echo $tax_name; ?>" type="text" id="new-tag-<?php echo $tax_name; ?>" name="newtag[<?php echo $tax_name; ?>]" class="newtag form-control form-input-tip" autocomplete="off" aria-describedby="new-tag-<?php echo $tax_name; ?>-desc" value="" />
...
<textarea rows="1" cols="40" name="excerpt" class="form-control" id="excerpt"><?php echo $post->post_excerpt; // textarea_escaped ?></textarea>
<p>
	<?php
	printf(
...
function post_slug_meta_box( $post ) {
	/** This filter is documented in ADMIN_DIR/edit-tag-form.php */
...
<div id="major-publishing-actions">
	<?php
	/** This action is documented in ADMIN_DIR/includes/meta-boxes.php */
...
<div id="taxonomy-linkcategory" class="categorydiv">
	...
	<div id="category-adder" class="wp-hidden-children">
		<a id="category-add-toggle" href="#category-add" class="taxonomy-add-new">
			<i class="gg-add"></i><?php _e( ' Add New Category' ); ?>
		</a>
		<p id="link-category-add" class="wp-hidden-child">
			<label class="screen-reader-text" for="newcat"><?php _e( '+ Add New Category' ); ?></label>
			<input type="text" name="newcat" id="newcat" class="form-control form-required form-input-tip" value="<?php esc_attr_e( 'New category name' ); ?>" aria-required="true" />
