...
require_once ABSPATH . ADMIN_DIR . '/includes/edit-tag-messages.php';
...
?>
	<table class="form-table" role="presentation">
		<tr class="form-field form-required term-name-wrap">
			<th scope="row">
				<label for="name"><?php _ex( 'Name', 'term name' ); ?></label>
			</th>
			<td>
				<input class="form-control" name="name" id="name" type="text" value="<?php echo $tag_name_value; ?>" size="40" aria-required="true" />
...
<?php if ( ! global_terms_enabled() ) { ?>
		<tr class="form-field term-slug-wrap">
			...
			?>
			<td><input class="form-control" name="slug" id="slug" type="text" value="<?php echo esc_attr( $slug ); ?>" size="40" />
...
<?php endif; // is_taxonomy_hierarchical() ?>
		<tr class="form-field term-description-wrap">
			...
			<td><textarea name="description" id="description" rows="5" cols="50" class="form-control"><?php echo $tag->description; // textarea_escaped ?></textarea>
