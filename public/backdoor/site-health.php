...
if ( current_user_can( 'view_site_health_checks' ) ) {
	wp_die( __( 'Temporary disabled.' ), '', 403 );
}
...
<div class="health-check-body hide-if-no-js">
	...
	<div class="site-status-has-issues">
		...
		<p class="lead"><?php _e( 'The site health check shows critical information about your CMS configuration and items that require your attention.' ); ?></p>
