...
if ( isset( $_GET['action'] ) ) {
	...
	if ( 'update-selected' == $action ) {
		...
		include_once ABSPATH . ADMIN_DIR . '/includes/plugin-install.php'; // For plugins_api().
		...
		include_once ABSPATH . ADMIN_DIR . '/includes/class-wp-upgrader.php'; // For themes_api().
