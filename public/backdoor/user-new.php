...
/**
	...
	I chose this page to rewrite with OOP in mind after I read about it on
...
require_once __DIR__ . '/classes/user-new-init.php';
//require_once __DIR__ . '/classes/add-existent-user.php';
//require_once __DIR__ . '/classes/create-new-user.php';

// Let's populate our class with some infos about the current website & user
$config = array(
