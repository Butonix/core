...
switch ( $action ) {
		...
		<form class="admin-email-confirm-form" name="admin-email-confirm-form" action="<?php echo esc_url( site_url( 'login.php?action=confirm_admin_email', 'login_post' ) ); ?>" method="post">
			...
			<div class="admin-email__actions">
				<div class="admin-email__actions-primary">
					...
					$change_link = admin_url( 'settings/index.php' );
	...
	default:
		...
		if ( isset( $_REQUEST['redirect_to'] ) ) {
			...
			if ( $secure_cookie && false !== strpos( $redirect_to, ADMIN_DIR ) ) {
		...
		if ( ! is_wp_error( $user ) && ! $reauth ) {
			...
			if ( ( empty( $redirect_to ) || ADMIN_DIR . '/' === $redirect_to || admin_url() === $redirect_to ) ) {
