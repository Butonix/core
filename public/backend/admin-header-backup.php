 ...
 */
global $title, $current_screen, $wp_locale, $pagenow,
 ...
 * 2. Not all core admin classes are filterable, notably: ADMIN_DIR, wp-core-ui,
...
<div id="wpwrap">
<?php require ABSPATH . ADMIN_DIR . '/menu-header.php'; ?>
<div id="wpcontent">
...
if ( 'settings/index.php' === $parent_file ) {
  require ABSPATH . ADMIN_DIR . '/settings/settings-head.php';
}
