...
class WP_Site_Health_Auto_Updates {
	...
	public function test_filters_automatic_updater_disabled() {
		/** This filter is documented in ADMIN_DIR/includes/class-wp-automatic-updater.php */
	...
	public function test_wp_automatic_updates_disabled() {
		if ( ! class_exists( 'WP_Automatic_Updater' ) ) {
			require_once ABSPATH . ADMIN_DIR . '/includes/class-wp-automatic-updates.php';
		}
	...
	function test_accepts_dev_updates() {
		...
		/** This filter is documented in ADMIN_DIR/includes/class-core-upgrader.php */
