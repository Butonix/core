 ...
 * @since 1.5.0
 * @deprecated 2.9.0
 * @uses WP_CONTENT_DIR Full filesystem path to the WP_CONTENT_DIR directory.
 *
 * @param string $file Filesystem path relative to the WP_CONTENT_DIR directory.
...
function wp_tiny_mce( $teeny = false, $settings = false ) {
	...
	if ( ! class_exists( '_WP_Editors', false ) )
		require_once ABSPATH . WPINC . '/classes/class-wp-editor.php';
...
function wp_update_core($current, $feedback = '') {
	...
	require ABSPATH . ADMIN_DIR . '/includes/class-wp-upgrader.php';
