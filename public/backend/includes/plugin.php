 ...
 * (WP_CONTENT_DIR/plugins) and in one directory above the plugins directory
 * (WP_CONTENT_DIR/plugins/my-plugin). The file it looks for has the plugin data
 ...
 *
 * WordPress only includes mu-plugin files in the base mu-plugins directory (WP_CONTENT_DIR/mu-plugins).
 *
 * @since 3.0.0
...
function get_mu_plugins() {
	...
	// Files in WP_CONTENT_DIR/mu-plugins directory.
...
/**
 * Check the WP_CONTENT_DIR directory and retrieve all drop-ins with any plugin data.
 *
 * @since 3.0.0
...
function get_dropins() {
	...
	// Files in WP_CONTENT_DIR directory.
...
function add_submenu_page( $parent_slug, $page_title, $menu_title, $capability, $menu_slug, $function = '', $position = null ) {
	 ...
	 * See ADMIN_DIR/admin.php for redirect from edit.php to tools.php.
	 */
...
function add_options_page( $page_title, $menu_title, $capability, $menu_slug, $function = '', $position = null ) {
	return add_submenu_page( 'settings/index.php', $page_title, $menu_title, $capability, $menu_slug, $function, $position );
}
 ...
 *
 * @since 3.0.0
 * @since 4.4.0 Function was moved into the `ADMIN_DIR/includes/plugin.php` file.
 *
 * @param string $plugin Path to the plugin file relative to the plugins directory.
 */
	...
	if ( ! is_admin() ) {
		_doing_it_wrong(
			...
			sprintf(
				...
				__( 'The suggested privacy policy content should be added only in dashboard by using the %s (or later) action.' ),
